namespace TPRandomizer
{
    ...
    {
        public static List<string> forestRequirementChecks = new()
        {
        ...
        public static List<string> minesRequirementChecks = new()
        {
        ...
        public static List<string> lakebedRequirementChecks = new()
        {
        ...
        public static List<string> arbitersRequirementChecks = new()
        {
        ...
        public static List<string> snowpeakRequirementChecks = new()
        {
        ...
        public static List<string> totRequirementChecks = new()
        {
        ...
        public static List<string> cityRequirementChecks = new()
        {
        ...
        public static List<string> palaceRequirementChecks = new()
        {
