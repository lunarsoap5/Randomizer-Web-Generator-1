...
window.tpr.checkData = {
  ...
  'Bulblin Camp First Chest Under Tower At Entrance': {
    category: ['Overworld', 'Chest', 'Bulblin Camp', 'DZX'],
    itemId: 'Arrows_20',
  },
  'Bulblin Camp Poe': {
  ...
  'Bulblin Camp Roasted Boar': {
    category: ['Overworld', 'Bulblin Camp', 'Boss'],
    itemId: 'Piece_of_Heart',
  },
  ...
  'Faron Mist Cave Open Chest': {
    category: ['Overworld', 'Chest', 'Faron Woods', 'Small Key', 'ARC'],
    itemId: 'North_Faron_Woods_Gate_Key',
  },
  ...
  'Faron Woods Owl Statue Sky Character': {
    category: ['Overworld', 'Faron Woods', 'Sky Book'],
    itemId: 'Progressive_Sky_Book',
  },
  'Fishing Hole Bottle': {
  ...
  'Sacred Grove Baba Serpent Grotto Chest': {
    category: ['Overworld', 'Chest', 'Sacred Grove', 'DZX'],
    itemId: 'Piece_of_Heart',
  },
  'Sacred Grove Female Snail': {
    category: ['Overworld', 'Golden Bug', 'Sacred Grove', 'DZX'],
    itemId: 'Female_Snail',
  },
  ...
  'Snowpeak Cave Ice Lantern Chest': {
    category: ['Overworld', 'Chest', 'Snowpeak Province', 'ARC'],
    itemId: 'Orange_Rupee',
  },
  ...
  'Snowpeak Freezard Grotto Chest': {
    category: ['Overworld', 'Chest', 'Snowpeak Province', 'DZX'],
    itemId: 'Orange_Rupee',
  },
